                    ...
                    <div class="card-body">
                       <div class="row">
                            ...
                            <div class="col text-end align-middel">
                                <i v-on:click="Object.assign(create_client, v)"  class="fa-solid fa-plus fa-2x radius-30 mt-2 mt-lg-0 text-info" data-bs-toggle="modal" data-bs-target="#themModal" type="button"></i>
                            </div>
                       </div>
                       <!-- Thêm mới -->
                       <div class="modal fade" id="themModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-footer">
                                ...
                                <button v-on:click="createLop()" type="button" class="btn btn-info" data-bs-dismiss="modal">Thêm</button>
                            </div>
                            </div>
                        </div>
                        </div>
                            ...
                            <tbody  class="text-center">
                                <tr v-for="(v, k) in list_lop_dang_ki">
                                    ...
                                    <div class="col text-start">
                                        <i v-on:click="Object.assign(delete_lop_dang_ki, v)" class="fa-solid fa-trash fa-2x text-danger" data-bs-toggle="modal" data-bs-target="#xoaModal" type="button"></i>
                                    </div>
                                </div>
                                    </td>
                                </tr>
                        ...
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                <button v-on:click="editLop()" type="button" class="btn btn-info" data-bs-dismiss="modal">Cập Nhật</button>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                <button type="button" class="btn btn-danger" v-on:click="deleteLopDangKi()" data-bs-dismiss="modal">Xóa</button>
                            </div>
                            </div>
                        </div>
                    </div>
