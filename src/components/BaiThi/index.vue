                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input v-model="create_bai_thi.ten_bai_thi" type="text" class="form-control" name=""
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input v-model="create_bai_thi.diem_tong" type="number" class="form-control">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input v-model="create_bai_thi.so_luong_cau_hoi" type="number" class="form-control"
                        ...
                        <div class="modal-footer">
                            ...
                            <button @click="createBaiThi()" type="button" class="btn btn-outline-primary">Thêm Mới</button>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <button class="btn btn-outline-primary" data-bs-toggle="modal"
                                                data-bs-target="#cauHoi">Tạo câu hỏi cho bài thi</button>
                                        </td>
                                    </tr>
                                </template>
                            </tbody>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-secondary close"
                                            data-bs-dismiss="modal">Đóng</button>
                                        <button type="button" class="btn btn-outline-primary">Thêm
                                            Mới</button>
                                    </div>
                                </div>
                            </div>
